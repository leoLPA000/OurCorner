...
function actualizarArbol() {
    ...
    if (mesActual !== 12) {
        arbolImg.src = 'assets/images/navidad/arbol-etapa1.png';
    ...
    if (diaActual >= 1 && diaActual <= 8) {
        ...
        arbolImg.src = 'assets/images/navidad/arbol-etapa2.png';
        arbolMensaje.textContent = '¡El árbol está creciendo más! 🎄';
    } else if (diaActual >= 17 && diaActual <= 24) {
        arbolImg.src = 'assets/images/navidad/arbol-etapa3.png';
